...
const { getBuffer, fetchJson, fetchText, getRandom, getGroupAdmins, bytesToSize, runtime, sleep, makeid } = require("../lib/myfunc");
...
module.exports = async(conn, msg, m, setting, store, welcome) => {
	try {
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `YouTube`, url : setting.medsos.youtube } },
        ...
        case prefix+'bagi':
			...
			case prefix+'help':
			    ...
			    conn.send5ButLoc(from , teks, `© ${setting.ownerName}`, fs.readFileSync(setting.pathimg), buttonsDefault, msg)
				break
			case prefix+'runtime':
			...
			case prefix+'tiktok':
			    ...
			    var fatih = await fetchJson(`https://fatiharridho.herokuapp.com/api/downloader/tiktok?url=${args[1]}`)
			      conn.sendMessage(from, {
				   video: { url: fatih.result.download.with_wm },
